        ...
        {!isAnyOpen && (
          <motion.button
            ...
            className={cn(
              ...
              "bg-glass-strong backdrop-blur-xl border border-border/50",
              "shadow-raised",
              "hover:bg-glass-strong-hover hover:border-border transition-colors",
              "active:scale-95",
              pillClassName
            )}
        ...
        {expanded && (
          <motion.div
            ...
            className={cn(
              ...
              "rounded-3xl bg-glass-overlay backdrop-blur-xl",
