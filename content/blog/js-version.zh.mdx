...
<Figure url="/img/post-bg-js-version.jpg" alt="「译」ES5, ES6, ES2016, ES.Next: JavaScript 的版本是怎么回事？" size="large" />
...
<small className="img-hint">歪果仁的笑话怎么一点都不好笑</small>
...
<img className="shadow" width="320" src="/img/in-post/post-js-version/keep-calm-and-learn-javascript.png" />
<small className="img-hint">来学 JavaScript 吧！</small>
