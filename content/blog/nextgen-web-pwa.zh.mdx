...
featured: true
tags: ["Web", "PWA"]
origin: "《程序员》杂志社邀稿，首发于 [CSDN](http://geek.csdn.net/news/detail/135595) 与《程序员》2017 年 2 月刊"
---

<Figure url="/img/post-bg-nextgen-web-pwa.jpg" alt="下一代 Web 应用模型 —— Progressive Web App" size="large" />
