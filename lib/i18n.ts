...
export const translations = {
  en: {
    ...
    wallpaperWeatherGradientMeta: "css · gradient · realtime",
    wallpaperWeatherClassic: "Classic",
    wallpaperWeatherClassicMeta: "css · gradient · presets",
  ...
  zh: {
    ...
    wallpaperWeatherGradientMeta: "CSS · 渐变 · 全实时",
    wallpaperWeatherClassic: "经典",
    wallpaperWeatherClassicMeta: "CSS · 渐变 · 预设",
