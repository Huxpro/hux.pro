...
export const translations = {
  en: {
    ...
    tiltPrimerTitle: "Let the rain lean",
    tiltPrimerBody: "Rain and snow here fall along real gravity, not down the page. Turn on tilt and the sky leans with the device in your hand.",
    tiltPrimerAsk: "Next, this browser will ask you for motion access.",
    tiltPrimerConfirm: "Tilt the sky",
    tiltPrimerDismiss: "Not now",
    tiltPrimerAgain: "You can change this any time under Wallpaper › Weather › Tilt.",
    tiltPrimerGranted: "Tilt is on — lean the device.",
    tiltPrimerDenied: "Motion access was refused. You can allow it again in the browser's settings for this site.",
  ...
  zh: {
    ...
    tiltPrimerTitle: "让雨斜下来",
    tiltPrimerBody: "这里的雨雪沿真实重力方向落下，而不是沿着页面向下。打开陀螺仪，天空便随手中的设备一起倾斜。",
    tiltPrimerAsk: "接下来浏览器会向你申请动作权限。",
    tiltPrimerConfirm: "打开陀螺仪",
    tiltPrimerDismiss: "暂不",
    tiltPrimerAgain: "随时可在「墙纸 › 天气 › 陀螺仪」中更改。",
    tiltPrimerGranted: "陀螺仪已打开 —— 倾斜试试。",
    tiltPrimerDenied: "动作权限已被拒绝。可在浏览器的本站设置中重新允许。",
    wallpaperCategoryApple: "Apple",
