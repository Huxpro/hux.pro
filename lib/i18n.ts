...
export const translations = {
  en: {
    ...
    logFilterTypes: "Filter by type",
    logFilterReset: "Show all types",
    logFilterEmpty: "nothing on this branch.",
  ...
  zh: {
    ...
    logExpandAll: "展开",
    logCollapseAll: "收起",
    logFilterTypes: "按类型筛选",
    logFilterReset: "显示全部类型",
    logFilterEmpty: "这条分支上没有提交。",
    writingFeatured: "精选",
