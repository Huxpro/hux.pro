...
export const translations = {
  en: {
    ...
    widgetFeaturedTalks: "featured talks",
    ...
    wallpaperPickerTitle: "Wallpaper",
    wallpaperPickerHint: "Weather and pictures are two kinds of the same surface.",
    wallpaperWeather: "Weather",
    wallpaperWeatherHint: "Living gradient from location, weather, and time.",
    wallpaperAuto: "Auto",
    wallpaperMacOS: "macOS",
    wallpaperIOS: "iOS",
    wallpaperUseLight: "Use light appearance",
    wallpaperUseDark: "Use dark appearance",
    wallpaperGradientFull: "Full",
    wallpaperGradientWidget: "Widget",
  ...
  zh: {
    ...
    wallpaperPickerTitle: "壁纸",
    wallpaperPickerHint: "天气与图片是同一种背景表面的两种壁纸。",
    wallpaperWeather: "天气",
    wallpaperWeatherHint: "随位置、天气与时间变化的动态渐变。",
    wallpaperAuto: "自动",
    wallpaperMacOS: "macOS",
    wallpaperIOS: "iOS",
    wallpaperUseLight: "使用浅色外观",
    wallpaperUseDark: "使用深色外观",
    wallpaperGradientFull: "全屏",
    wallpaperGradientWidget: "卡片",
