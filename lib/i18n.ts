...
export const translations = {
  en: {
    ...
    wallpaperWeatherCg: "CG",
    wallpaperWeatherCgMeta: "shader · animated",
    wallpaperWeatherGradient: "Gradient",
    wallpaperWeatherGradientMeta: "css · flat",
    wallpaperNoWebGL: "No WebGL2 here — CG paints the gradient instead.",
    wallpaperWeatherFooter:
      "The sky outside, right now. Both tiles paint the same scene; CG animates it.",
  ...
  zh: {
    ...
    wallpaperWeatherCg: "CG",
    wallpaperWeatherCgMeta: "着色器 · 动态",
    wallpaperWeatherGradient: "渐变",
    wallpaperWeatherGradientMeta: "CSS · 平面",
    wallpaperNoWebGL: "此浏览器不支持 WebGL2，CG 会退回渐变。",
    wallpaperWeatherFooter: "此刻窗外的天空。两张画的是同一个场景，CG 会动。",
    wallpaperCategoryApple: "Apple",
