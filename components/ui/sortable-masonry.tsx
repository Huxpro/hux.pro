        ...
        {editing && (
          ...
          >
            ...
            <button
              ...
              className="pressable rounded-full border border-border/60 bg-glass-solid px-5 py-2.5 md:px-4 md:py-1.5 text-xs font-mono uppercase tracking-wider text-muted-foreground shadow-raised backdrop-blur-xl transition-colors hover:text-foreground active:bg-card active:text-foreground"
            >
