        ...
        {editing && (
          ...
          >
            ...
            <button
              ...
              className="rounded-full border border-border/60 bg-glass-strong-hover px-4 py-1.5 text-xs font-mono uppercase tracking-wider text-muted-foreground shadow-raised backdrop-blur-xl transition-colors hover:text-foreground"
            >
