...
const STRINGS = {
  en: {
    ...
    policy: "Policy — desktop: ink, relief, flip, glass",
    policyReading: "Policy — reading routes: veil and blur",
  ...
  zh: {
    ...
    policy: "策略 — 桌面：墨、浮雕、反色、玻璃",
    policyReading: "策略 — 阅读页：压暗与虚化",
...
const KNOBS_ZH: Record<string, { label: string; hint?: string }> = {
  ...
  dropBias: { label: "投影偏向", hint: "浅色墨的先手分，随繁忙度增长 — 光晕只在纹理上失效" },
