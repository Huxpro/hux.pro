...
export function DayTimeline({
  ...
  const ticks = [
    { m: minutesInto(events.sun.rise, dayStartMs), label: `↑ ${clock(events.sun.rise)}`, color: SUN_COLOR },
    { m: minutesInto(events.sun.set, dayStartMs), label: `↓ ${clock(events.sun.set)}`, color: SUN_COLOR },
    { m: minutesInto(events.moon.rise, dayStartMs), label: `↑ ${clock(events.moon.rise)}`, color: MOON_COLOR },
    { m: minutesInto(events.moon.set, dayStartMs), label: `↓ ${clock(events.moon.set)}`, color: MOON_COLOR },
