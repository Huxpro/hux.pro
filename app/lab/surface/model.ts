...
export const SURFACES: SurfaceSpec[] = [
  ...
  },
  {
    ...
    z: 2,
    role: "画中画的悬浮控制条",
    note: "card/85 越过 glass 上限(70)。它和 Glass Capsule(90)、web-frame(95) 一起，构成 card 平面上一簇 α 85–95 的 solid-card control — 一个反复出现、surface() 尚未表达的新档。",
    status: "drift",
  },
  {
    id: "glass-capsule",
    name: "Theater Glass Capsule",
    file: "systems/theater/components/album-tabs.tsx",
    plane: "card",
    alpha: 90,
    blur: "xl",
    shadow: "raised",
    ...
    radius: 999,
    z: 1,
    role: "Featured Talks 的活动 tab 胶囊（#84）",
    note: "本轮 rebase 新增：card/90 + ring/50 + 顶部 before: 亮边。又一个 solid-card control(现已三例：85/90/95)。它用 ring 而非 border、shadow-sm 而非 raised token — solid 档若要被 sanction，这些也得一起收敛。",
    status: "drift",
  },
  {
    id: "palette",
