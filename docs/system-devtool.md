...
1. **Wallpaper**: the whole background system — a Weather / Image switch and
   ...
   (full / widget / soft edge), the bezel switch and its tint, band and radius,
   a scroll lock with the current scroll mode as a badge, the reading treatment
   switches (reading blur / reading dim),
