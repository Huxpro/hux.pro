...
Kind (weather / image), built-in pair, Auto / Light / Dark, Glass (Clear / Tinted), and an ephemeral override for previewing without writing `localStorage`. See [system-wallpaper.md](./system-wallpaper.md).
